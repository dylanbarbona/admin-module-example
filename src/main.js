...
(function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, document, prismaService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, app.listen(process.env.PORT || 3000, function () { return console.debug('Listening on port ' + (process.env.PORT || 3000)); })];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
