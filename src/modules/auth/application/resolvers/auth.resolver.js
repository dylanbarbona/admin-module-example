...
var graphql_guard_1 = require("../guards/graphql.guard");
...
var AuthResolver = /** @class */ (function () {
    ...
    __decorate([
        (0, common_1.UseGuards)(graphql_guard_1.GqlAuthGuard),
        (0, graphql_1.Query)(function () { return user_entity_1.User; }, { name: 'mobileAuth' }),
